...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int REQUEST_TAKE_IMG_ALBUM = 33;
    private static final int REQUEST_TAKE_VIDEO_ALBUM = 4;
    private static final int REQUEST_IMAGE_CROP = 5;

    Button btn_capture, btn_img_album,btn_video_album, btn_recording, btn_googleMap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_img_album = findViewById(R.id.btn_img_album);
        btn_video_album = findViewById(R.id.btn_video_album);
        ...
        btn_img_album.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getImgAlbum();
            }
        });
        btn_video_album.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getVideoAlbum();
            }
    ...
    private void getVideoAlbum(){
        ...
        startActivityForResult(intent, REQUEST_TAKE_VIDEO_ALBUM);
    }
